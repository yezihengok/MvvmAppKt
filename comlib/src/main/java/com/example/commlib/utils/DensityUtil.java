...
public class DensityUtil {
    ...
    public static int getScreenWidth() {
        return App.Companion.getInstance().getResources().getDisplayMetrics().widthPixels;
    }

    public static int getScreenHeight() {
        return App.Companion.getInstance().getResources().getDisplayMetrics().heightPixels;
    }
}
