...
public final class BarUtils {
    ...
    public static int getActionBarHeight() {
        ...
        if (App.Companion.getInstance().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, App.Companion.getInstance().getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = App.Companion.getInstance().getSystemService("statusbar");
    ...
    public static int getNavBarHeight() {
        Resources res = App.Companion.getInstance().getResources();
    ...
    public static void setNavBarVisibility(@NonNull final Window window, boolean isVisible) {
        ...
        for (int i = 0, count = decorView.getChildCount(); i < count; i++) {
            ...
            if (id != View.NO_ID) {
                String resourceEntryName = App.Companion.getInstance()
                        .getResources()
    ...
    public static boolean isSupportNavBar() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            WindowManager wm = (WindowManager) App.Companion.getInstance().getSystemService(Context.WINDOW_SERVICE);
        ...
        boolean menu = ViewConfiguration.get(App.Companion.getInstance()).hasPermanentMenuKey();
