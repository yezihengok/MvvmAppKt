...
public final class AppUtils {
    ...
    public static <T> T getSystemService(final String name) {
        ...
        try {
            return (T) App.Companion.getInstance().getSystemService(name);
        } catch (Exception e) {
    ...
    public static PackageManager getPackageManager() {
        try {
            return App.Companion.getInstance().getPackageManager();
        } catch (Exception e) {
    ...
    public static ApplicationInfo getApplicationInfo() {
        try {
            return App.Companion.getInstance().getApplicationInfo();
        } catch (Exception e) {
    ...
    public static ApplicationInfo getApplicationInfo(final String packageName, final int flags) {
        try {
            return App.Companion.getInstance().getPackageManager().getApplicationInfo(packageName, flags);
        } catch (Exception e) {
    ...
    public static PackageInfo getPackageInfo(final String packageName, final int flags) {
        try {
            return App.Companion.getInstance().getPackageManager().getPackageInfo(packageName, flags);
        } catch (Exception e) {
    ...
    public static SharedPreferences getSharedPreferences(final String fileName, final int mode) {
        try {
            return App.Companion.getInstance().getSharedPreferences(fileName, mode);
        } catch (Exception e) {
    ...
    public static boolean deleteDatabase(final String dbName) {
        try {
            return App.Companion.getInstance().deleteDatabase(dbName);
        } catch (Exception e) {
    ...
    public static String getPackageName() {
        try {
            return App.Companion.getInstance().getPackageName();
        } catch (Exception e) {
    ...
    public static boolean startActivity(final Intent intent) {
        ...
        try {
            App.Companion.getInstance().startActivity(IntentUtils.getIntent(intent, true));
            return true;
        } catch (Exception e) {
    ...
    public static boolean registerReceiver(final BroadcastReceiver receiver, final IntentFilter filter) {
        ...
        try {
            App.Companion.getInstance().registerReceiver(receiver, filter);
            return true;
        } catch (Exception e) {
    ...
    public static boolean unregisterReceiver(final BroadcastReceiver receiver) {
        ...
        try {
            App.Companion.getInstance().unregisterReceiver(receiver);
            return true;
        } catch (Exception e) {
    ...
    public static boolean sendBroadcast(final Intent intent) {
        if (intent == null) return false;
        try {
            App.Companion.getInstance().sendBroadcast(intent);
            return true;
        } catch (Exception e) {
    ...
    public static boolean sendBroadcast(final Intent intent, final String receiverPermission) {
        ...
        try {
            App.Companion.getInstance().sendBroadcast(intent, receiverPermission);
            return true;
        } catch (Exception e) {
            ALog.eTag(TAG, e, "sendBroadcast");
        }
    ...
    public static boolean startService(final Intent intent) {
        if (intent == null) return false;
        try {
            App.Companion.getInstance().startService(intent);
            return true;
        } catch (Exception e) {
    ...
    public static boolean stopService(final Intent intent) {
        if (intent == null) return false;
        try {
            App.Companion.getInstance().stopService(intent);
            return true;
        } catch (Exception e) {
