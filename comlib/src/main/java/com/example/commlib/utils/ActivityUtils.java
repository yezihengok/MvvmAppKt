...
public final class ActivityUtils {
    ...
    public static Drawable getActivityIcon(final Class<?> clazz) {
        ...
        try {
            return getActivityIcon(new ComponentName(App.Companion.getInstance(), clazz));
        } catch (Exception e) {
    ...
    public static Drawable getActivityLogo(final Class<?> clazz) {
        if (clazz == null) return null;
        try {
            return getActivityLogo(new ComponentName(App.Companion.getInstance(), clazz));
        } catch (Exception e) {
    ...
    public static class ResultActivity extends FragmentActivity {
        ...
        protected static boolean start(final ResultCallback resultCallback) {
            ...
            if (resultCallback != null) {
                ...
                try {
                    Intent intent = new Intent(App.Companion.getInstance(), ResultActivity.class);
