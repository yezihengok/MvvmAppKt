 ...
 */
class WebProgress(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : FrameLayout(context, attrs, defStyleAttr) {
    /**
     * 进度条颜色
     */
    ...
    fun setColor(startColor: Int, endColor: Int) {
        val linearGradient: LinearGradient =
            LinearGradient(0f, 0f, mTargetWidth.toFloat(), mTargetHeight.toFloat(), startColor, endColor, Shader.TileMode.CLAMP)
