...
//
//
////        RxBus.getInstance().postSticky(new EventSticky("aa"));
////        RxBus.getInstance().toObservableSticky(EventSticky.class).subscribe(new Consumer<EventSticky>() {
////        @Override
